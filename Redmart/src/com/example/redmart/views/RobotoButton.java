...
/**
 * Implementation of a {@link android.widget.Button} with native support for all the Roboto fonts.
 *
 * @author e.shishkin
 */
public class RobotoButton extends Button {
     ...
     * @see #RobotoButton(android.content.Context, android.util.AttributeSet, int)
     */
     ...
     * @see #RobotoButton(android.content.Context, android.util.AttributeSet)
     */
